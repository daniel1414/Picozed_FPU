...
#
# Generated by export_simulation on Tue Jan 05 11:12:34 +0100 2021
#
################################################################################
...
'-reset_run' switch to the './System_design.sh' script.

./System_design.sh -reset_run
...
./System_design.sh -noclean_files

For more information on the script, please type './System_design.sh -help'.
