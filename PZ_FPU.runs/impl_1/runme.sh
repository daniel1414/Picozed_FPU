...
HD_PWD='D:/Xilinx_projects/PZ_FPU/PZ_FPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log System_design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source System_design.tcl -notrace
