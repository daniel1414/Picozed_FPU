...
HD_PWD='D:/Xilinx_projects/PZ_FPU/PZ_FPU.runs/System_design_FPU_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log System_design_FPU_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source System_design_FPU_ip_0_0.tcl
