...
HD_PWD='D:/Xilinx_projects/PZ_FPU/PZ_FPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log System_design.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source System_design.tcl
